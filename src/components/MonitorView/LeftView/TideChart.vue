...
export default {
  ...
  methods: {
    TideChart() {
      var myChart = echarts.init(document.getElementById("Tide"));
      this.tideChart = myChart;
      // 绘制图表
      myChart.setOption({
        title: {
          text: "潮位",
    ...
    changeData() {
      for (let i = 0; i < 6; i++) {
        ...
        this.Tidedata[i] = randomNumber;
      }
      this.tideChart.setOption({
        series: [
          {
            name: "潮位",
            data: this.Tidedata,
